...
public class EnvSimulator extends Thread{
    ...
    public void run(){
		...
		try {
			...
			/*Itinerary i2 = new Itinerary("data/dados.xml", "1");
			...
			if (i2.isOn()) {
				...
				Auto a2 = new Auto(true, "GO2", red,"D2", sumo, 300, fuelType, fuelPreferential, fuelPrice, personCapacity, personNumber);

				TransportService tS2 = new TransportService(true, "GO2", i2, a2, sumo);
				tS2.start();
				a2.start();
			}*/
